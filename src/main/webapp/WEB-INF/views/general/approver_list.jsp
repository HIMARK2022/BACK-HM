                            ...
                            <table class="table table-bordered" id="dataTable11" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <c:if test="${Tempteam[0].user_id ne null}">
		                                    <tr>    
		                                        <td>
			                                        <span data-toggle="tooltip" data-placement="top" title="${ user_team[0].dept_name} / ${ user_team[0].pos_name}">
														${user_team[0].user_name}
													</span>
		                                        </td>                                       
		                                        ...
		                                        <td>
		                                        	<span data-toggle="tooltip" data-placement="top" title="<fmt:formatDate value="${Tempteam[0].approval_start}" pattern="yyyy-MM-dd" /> ~ <fmt:formatDate value="${Tempteam[0].approval_finish}" pattern="yyyy-MM-dd" />">
		                                        		${Tempteam[0].duty_name}
		                                        	</span>
		                                        </td>
		                                    </tr>
                                    </c:if>
                                    <c:if test="${Tempdepart[0].user_id ne null}">                                  
		                                    <tr>
		                                        <td >
		                                        	<span data-toggle="tooltip" data-placement="top" title="${ user_dept[0].dept_name} / ${ user_dept[0].pos_name}">
														${user_dept[0].user_name}
													</span>
		                                        </td>                                       
                                    ...
                                    <c:if test="${Tempupper[0].user_id ne null}">                             
		                                    <tr>
		                                        <td >
		                                        	<span data-toggle="tooltip" data-placement="top" title=" ${ user_upper[0].dept_name} / ${ user_upper[0].pos_name}">
														${user_upper[0].user_name}
													</span>
		                                        </td>
